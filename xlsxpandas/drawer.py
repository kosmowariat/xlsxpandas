...
class Drawer(object):
    ...
    @property
    def ws(self):
        """xlsxwriter.worksheet.Worksheet: Excel worksheet the drawer is placed in."""
        return self._ws
    @ws.setter
    def ws(self, value):
    ...
    @property
    def wb(self):
        """xlsxwriter.workbook.Workbook: Excel workbook the drawer is placed in."""
        return self._wb
    @wb.setter
    def wb(self, value):
    ...
    def draw(self, elem, **kwargs):
        ...
        Parameters
        ----------
            elem : any object with a proper `draw` method and `width` and `height` properties.
